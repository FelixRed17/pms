class CreateQuestionnaireTemplates < ActiveRecord::Migration[8.1]
  def change
    ...
    add_index :questionnaire_templates, :audience_type, unique: true
    ...
    add_index :question_templates, [:questionnaire_template_id, :position], unique: true, name: "idx_question_templates_on_template_and_position"
  end
end
